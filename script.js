...
function renderGame() {
    let dt = 1; // intervalo de tiempo

    // Método de Euler:
    velocityY = velocityY + gravity * dt; // actualizar velocidad
    bird.y = Math.max(bird.y + velocityY * dt, 0); // actualizar posición
